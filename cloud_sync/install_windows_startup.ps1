...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Description "Continuously sync local repo from cloud changes for Aevra." | Out-Null
